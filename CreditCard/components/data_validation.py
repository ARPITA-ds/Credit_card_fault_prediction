...
class DataValidation:
    ...
    #First validate whether test or train file present or not
    ...
    def validate_dataset_schema(self)->bool:
        try:
            ...
            #reading column name from schema.yaml file
            schema_file_path = self.data_validation_config.schema_file_path
            columns = read_yaml_file(file_path=schema_file_path)['columns']
    ...
    def get_and_save_data_drift_report(self):
        try:
            ...
            # Two dataset to know the data drift(statics variation)
            train_df,test_df = self.get_train_and_test_df()

            # Data drift is being calculated
