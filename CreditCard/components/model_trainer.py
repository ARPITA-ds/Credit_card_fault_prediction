...
from CreditCard.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact , DataIngestionArtifact
from CreditCard.entity.config_entity import ModelTrainerConfig
from CreditCard.entity.model_factory import MetricInfoArtifact, ModelFactory, GridSearchedBestModel,evaluate_classification_model
import pandas as pd 
from CreditCard.util.util import load_numpy_array_data, save_object, load_object , reduce_mem_usage
import os
import sys
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        try:
            ...
            X_train = train_df.drop(columns=['default', "ID"], axis=1)
            y_train = train_df['default']
            X_test = test_df.drop(columns=['default', "ID"], axis=1)
